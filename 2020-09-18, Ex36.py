...
def findWeapon():
    ...
    if choice == "YANK":  # in choice or "yank" in choice:
        ...
        print("C'mon Man!  You shoud know better by now.")
        findWeapon()
...
def bats():
    ...
    if rocks < 5:
        ...
        death("Because of your age, your arm gives out and you can't throw anything! You are swarmed by the colony of bats.  One of them bites you and you die of rabies!")
#        else:
#            print("You do know I am going to do some sort of error checking, right?")
#            tryAgain()
#    except UnboundLocalError:
#        print(">>>> I got here")
